...
- **Поворот танцора (dancer's rotation)**. Определяется как угол, между линией пары (от головы партнера к голове партнерши) и направлением взгляда танцора (линия взгляда всегда предполагается перпендикулярной линии плеч). Во всех базовых фигурах, вроде, ограничивается, 4 значениями: 0, 90&deg;, -90&deg;, 180&deg;.
